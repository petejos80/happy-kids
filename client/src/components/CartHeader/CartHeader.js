        ...
        cartItems = this.state.cart.map(product =>{
			return(
				<li className="cart-item" key={product.name}>
                    ...
                    <a className="product-remove" href="#" onClick={this.props.removeProduct.bind(this, product.id)}>x</a>
                </li>
			)
		});
        let view;
            ...
            <header>
              ...
              />
                    ...
                    <div className="search">
                        <a className="mobile-search" href="#" onClick={this.handleMobileSearch.bind(this)}><img className="image"src=".\images\search.png" alt="search" /></a>
                        <form action="#" method="get" className={this.state.mobileSearch ? "search-form active" : "search-form"}>
                            <a className="back-button" href="#" onClick={this.handleSearchNav.bind(this)}><img className="image"  src=".\images\backarrow.png" alt="back" /></a>
                            <input type="search" ref="searchBox" placeholder="Search for Toys" className="search-keyword" onChange={this.props.handleSearch}/>
                    ...
                    <div className="cart"> 
                        ...
                        <a className="cart-icon" href="#" onClick={this.handleCart.bind(this)} ref="cartButton">
                            <img className={this.props.cartBounce ? "tada" : " "} className="image"src=".\images\cart.png" alt="search" />
